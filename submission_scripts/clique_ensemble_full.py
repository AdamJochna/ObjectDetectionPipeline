...
subcompress_path = '/home/adam/Desktop/kaggleOID/FULLcsvs/fullClique_05_1600_subf_28_01h_09m.csv'
subcsv_path = '/home/adam/Desktop/kaggleOID/FULLcsvs/fullClique_05_1600_csvf_28_01h_09m.csv'

models = ['/home/adam/Desktop/kaggleOID/FULLcsvs/fullFrcnn150cls.csv',
          ...
          '/home/adam/Desktop/kaggleOID/FULLcsvs/predictionsFRCNN.csv',
          '/home/adam/Desktop/kaggleOID/FULLcsvs/predictionsInception.csv',
          '/home/adam/Desktop/kaggleOID/FULLcsvs/predictionsYOLOv3_OID.csv']
...
if full_IDs == 1:
    ...
    for idx, img_name in enumerate(sorted(os.listdir('/home/adam/Desktop/kaggleOID/eval/eval_imgs'))):
...
with open(models[0], 'r') as f0, \
    ...
    for pack in packslist:
        ...
        for ImID in pack:
            if vis:
                visualise('/home/adam/Desktop/kaggleOID/eval/eval_imgs/'+ImID+'.jpg', results_boxes_float[ImID], '/home/adam/Desktop/kaggleOID/clique_imgs_delthis/{}.jpg'.format(glob_idx))
...
with open('/home/adam/Desktop/kaggleOID/clique_ensemble_summary.csv','w') as summary:
